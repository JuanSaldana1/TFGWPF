...
namespace WpfApp3.ViewModel {
    internal class ProductViewModel {
        private IList<ProductoModel> Productos { get; set; } = new List<ProductoModel>();
        public ProductViewModel() {
            ...
            string mySelectQuery = "SELECT ProductId, Name, Description, Price, C.Nombre, Stock, Image FROM Productos JOIN Categorias C on C.CategoryId = Productos.CategoryId";
